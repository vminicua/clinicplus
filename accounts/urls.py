...
urlpatterns = [
    ...
    path("organizacao/clinicas/", views.ClinicListView.as_view(), name="clinic_list"),
    path("organizacao/clinicas/nova/", views.ClinicCreateView.as_view(), name="clinic_create"),
    path("organizacao/clinicas/<int:pk>/", views.ClinicDetailView.as_view(), name="clinic_detail"),
    path("organizacao/clinicas/<int:pk>/editar/", views.ClinicUpdateView.as_view(), name="clinic_update"),
    path(
        "organizacao/clinicas/<int:pk>/estado/",
        views.ClinicToggleStatusView.as_view(),
        name="clinic_toggle_status",
    ),

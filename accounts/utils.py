...
DEFAULT_ROLE_PERMISSION_MAP = {
    "Administrador do Sistema": {
        ...
        "view_clinic",
        "add_measurementunit",
        "change_measurementunit",
        "delete_measurementunit",
        "view_measurementunit",
        "add_paymentmethod",
        ...
        "delete_consumivel",
        "view_consumivel",
        "add_estoquemedicamento",
        "change_estoquemedicamento",
        "delete_estoquemedicamento",
        "view_estoquemedicamento",
        "add_estoqueconsumivel",
        "change_estoqueconsumivel",
        "delete_estoqueconsumivel",
        "view_estoqueconsumivel",
        "add_movimentoinventario",
        "change_movimentoinventario",
        "delete_movimentoinventario",
        "view_movimentoinventario",
        "add_pharmacysale",
        "change_pharmacysale",
        "delete_pharmacysale",
        "view_pharmacysale",
        "add_pharmacysaleitem",
        "change_pharmacysaleitem",
        "delete_pharmacysaleitem",
        "view_pharmacysaleitem",
        "add_departamento",
        "change_departamento",
        "delete_departamento",
        "view_departamento",

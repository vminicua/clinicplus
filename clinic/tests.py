...
class ClinicalStructureTests(TestCase):
    ...
    def test_inventory_pages_render(self):
        ...
        medication_catalog_response = self.client.get(reverse("clinic:medication_catalog_list"))
        medication_response = self.client.get(reverse("clinic:medication_list"))
        consumable_catalog_response = self.client.get(reverse("clinic:consumable_catalog_list"))
        ...
        self.assertEqual(medication_catalog_response.status_code, 200)
        self.assertContains(medication_catalog_response, medication.name)
        self.assertContains(medication_catalog_response, 'data-table-pill="medication-catalog-table"')
        ...
        self.assertEqual(consumable_catalog_response.status_code, 200)
        self.assertContains(consumable_catalog_response, consumable.name)
        self.assertContains(consumable_catalog_response, 'data-table-pill="consumable-catalog-table"')
